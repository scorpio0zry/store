		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/ProductServlet?cid=${product.category.cid }&method=findPage&currPage=1">${product.category.cname }&nbsp;&nbsp;&gt;</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商家价: <strong style="color:#ef0101;">￥：${product.shop_price }元</strong> &nbsp;&nbsp;&nbsp;&nbsp;参 考 价: <del>￥：${product.market_price }元</del>
						</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div style="text-align:center">
						<img src="${pageContext.request.contextPath }/${product.pimage}"></center>
						<br />
